...
var session = require('express-session'); // 霑ｽ蜉
/*const upload = multer({
  dest: 'uploads/tmp'
})*/
...
app . get ( '/' ,   function ( req ,   res ) {
          ...
          io.on('connection', function(socket){
            ...
            socket.on('hokuro',function(into){
              console.log(flg100 + "縺ｻ縺上ｍ騾√ｉ繧後※縺阪∪縺励◆");
              if(flg100 == 1){
                console.log("flg100蜈･繧翫∪縺励◆" + flg100);
                flg100 = 0;
                                  ...
                                  var lengthq = Object.keys(result).length;
                                    ...
                                    while (true) {
                                      ...
                                      lo4[x3]=lo3[x3];
                                        ...
                                        flg100=1;
                                        console.log(flg100 + "蜈･髫翫∪縺医�縺ｧ縺");
                                        socket.join(open);
                                        io.to(open).emit('nyutai',{
                                          username : bana
                                        });
